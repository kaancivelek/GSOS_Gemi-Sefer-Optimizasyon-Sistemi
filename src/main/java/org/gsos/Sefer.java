...
public class Sefer {
    ...
    public void giderHesapla() {
        Gemi.Motor motor = new Motor(2, true, "A kalite", 500); // Gemi motoru
        double yakitMaliyeti = motor.yakitHesapla(gemisi.ortHız, mesafe) * 10; // 1 litre yakıt maliyeti: 10 birim
        gider += yakitMaliyeti;
    }
